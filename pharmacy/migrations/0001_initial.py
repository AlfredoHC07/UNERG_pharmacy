# Generated by Django 4.2 on 2023-05-15 20:29
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('precio_total_compra', models.DecimalField(decimal_places=2, max_digits=8)),
                ('precio_total_venta', models.DecimalField(decimal_places=2, max_digits=8)),
                ('ganancias', models.FloatField()),
                ('reportes', models.TextField()),
                ('producto', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='pharmacy.producto')),
            ],
        ),
        migrations.CreateModel(
            name='Almacen',
